...
public class WorldGenTreeYedoensis extends WorldGenTreeBase {

    public WorldGenTreeYedoensis(boolean parShouldNotify) {
        super(parShouldNotify);

        setBlockStateLeaves(ModBlocks.LEAVES_YEDOENSIS.getDefaultState());
        setBlockStateWood(ModBlocks.LOG_YEDOENSIS.getDefaultState());
    }

    private static final IBlockState TRUNK = ModBlocks.LOG_YEDOENSIS.getDefaultState();
    private static final IBlockState LEAF = ModBlocks.LEAVES_YEDOENSIS.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
