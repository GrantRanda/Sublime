...
public class WorldGenTreeMaidenhair extends WorldGenTreeBase {

    public WorldGenTreeMaidenhair(boolean parShouldNotify) {
        super(parShouldNotify);

        setBlockStateLeaves(ModBlocks.LEAVES_MAIDENHAIR.getDefaultState());
        setBlockStateWood(ModBlocks.LOG_MAIDENHAIR.getDefaultState());
    }

    private static final IBlockState TRUNK = ModBlocks.LOG_MAIDENHAIR.getDefaultState();
    private static final IBlockState LEAF = ModBlocks.LEAVES_MAIDENHAIR.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
