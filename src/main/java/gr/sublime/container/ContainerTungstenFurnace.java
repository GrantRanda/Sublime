...
public class ContainerTungstenFurnace extends Container {
    ...
    public ContainerTungstenFurnace(InventoryPlayer playerInventory, TileEntityTungstenFurnace furnaceInventory) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 2) {
                ...
                } else if (TileEntityTungstenFurnace.isItemFuel(itemstack1)) {
